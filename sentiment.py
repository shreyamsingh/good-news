...
def makeDF(df, query):
    ...
    url = (r'https://newsapi.org/v2/everything?language=en&q=' + query + " NOT pandemic NOT dies NOT lawsuit NOT trump NOT sex" + r'&from=' + str(week_ago) + r'&to=' + str(today) + r'&sortBy=popularity&excludeDomains=techcrunch.com,theverge.com,theinventory.com,gizmodo.com&apiKey=' + api_key)
